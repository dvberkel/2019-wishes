...
{
	if (region.ak.P === region.aw.P)
	{
		return 'on line ' + region.ak.P;
	}
	return 'on lines ' + region.ak.P + ' through ' + region.aw.P;
}
...
var author$project$Plane$Plane = elm$core$Basics$identity;
var elm$core$Basics$identity = function (x) {
	return x;
};
var author$project$Plane$at = F2(
	function (aPosition, _n0) {
		var aPlane = _n0;
...
var author$project$Plane$Compass$North = 0;
var author$project$Plane$Position$position = F2(
	function (x, y) {
		return {a$: x, a0: y};
	});
var author$project$Plane$Tail$Tail = elm$core$Basics$identity;
...
var author$project$World$world = F4(
	function (delta, width, height, plane) {
		return {ab: delta, ad: height, t: plane, _: elm$core$Maybe$Nothing, ao: width};
	});
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {bi: index, bk: match, bv: number, bC: submatches};
	});
...
var author$project$Wish$init = function (flags) {
	...
	var expand = function (input) {
		return A3(
			...
			'EXPAND',
			A2(elm$core$String$repeat, flags.aj, ' '),
			input);
	};
	var message = A2(
		...
		A2(
			elm$core$Result$map,
			expand,
			truqu$elm_base64$Base64$decode(flags.H)));
	var aPlane = A2(
		author$project$Plane$heading,
		0,
		A2(
			author$project$Plane$at,
			A2(author$project$Plane$Position$position, flags.a$, flags.a0),
			author$project$Plane$plane));
	var aWorld = A4(author$project$World$world, flags.ab, width, height, aPlane);
	return _Utils_Tuple2(
		{G: flags.G, H: message, o: aWorld},
		A2(
			elm$random$Random$generate,
			author$project$Wish$Reward,
			author$project$World$rewardGenerator(aWorld)));
};
var author$project$Wish$Tick = {$: 1};
var author$project$Wish$DoNothing = {$: 0};
var author$project$Wish$Key = function (a) {
	return {$: 2, a: a};
};
var author$project$Plane$Compass$East = 1;
var author$project$Plane$Compass$South = 2;
var author$project$Plane$Compass$West = 3;
var author$project$Wish$toCompass = function (aDirection) {
	switch (aDirection) {
		case 0:
...
var author$project$Wish$rawKeyToMessage = function (rawKey) {
	return A2(
		elm$core$Maybe$withDefault,
		author$project$Wish$DoNothing,
		A2(
			elm$core$Maybe$map,
			author$project$Wish$Key,
			A2(
				elm$core$Maybe$andThen,
				author$project$Wish$toCompass,
				A2(
					elm$core$Maybe$map,
					ohanhi$keyboard$Keyboard$Arrows$arrowsDirection,
					A2(
						elm$core$Maybe$map,
						elm$core$List$singleton,
						ohanhi$keyboard$Keyboard$navigationKey(rawKey))))));
};
...
var elm$time$Time$State = F2(
	function (taggers, processes) {
		return {aN: processes, aZ: taggers};
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ay: fragment, aB: host, aJ: path, aL: port_, aO: protocol, aP: query};
	});
...
var author$project$Wish$subscriptions = function (_n0) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				ohanhi$keyboard$Keyboard$downs(author$project$Wish$rawKeyToMessage)
			]));
};
var author$project$Wish$eventToCommand = F2(
	function (aWorld, event) {
		return A2(
			elm$random$Random$generate,
			author$project$Wish$Reward,
			author$project$World$rewardGenerator(aWorld));
...
var folkertdev$elm_deque$BoundedDeque$fromList = F2(
	function (maxSize, elements) {
		return function (newDeque) {
			return A2(folkertdev$elm_deque$BoundedDeque$BoundedDeque, newDeque, maxSize);
		}(
			folkertdev$elm_deque$Internal$fromList(
				A2(elm$core$List$take, maxSize, elements)));
	});
...
var folkertdev$elm_deque$BoundedDeque$resize = F2(
	function (calculateMaxSize, _n0) {
		var deque = _n0.a;
		var maxSize = _n0.b;
		var newMaxSize = calculateMaxSize(maxSize);
		return (_Utils_cmp(deque.m + deque.n, newMaxSize) < 1) ? A2(folkertdev$elm_deque$BoundedDeque$BoundedDeque, deque, newMaxSize) : A2(
			folkertdev$elm_deque$BoundedDeque$fromList,
			newMaxSize,
			folkertdev$elm_deque$Internal$toList(deque));
	});
var author$project$Plane$Tail$incrementBy = F2(
	function (delta, _n0) {
		var aTail = _n0;
		var capacity = aTail.N;
		var nodes = aTail.r;
...
var author$project$Plane$moveTo = F2(
	function (_n0, direction) {
		...
		switch (direction) {
			case 0:
				return A2(author$project$Plane$Position$position, x, y + 1);
			case 1:
				return A2(author$project$Plane$Position$position, x + 1, y);
			case 2:
				return A2(author$project$Plane$Position$position, x, y - 1);
			default:
				return A2(author$project$Plane$Position$position, x - 1, y);
...
var folkertdev$elm_deque$BoundedDeque$reachedMaxSize = function (_n0) {
	var sizeF = _n0.a.m;
	var sizeR = _n0.a.n;
	var maxSize = _n0.b;
...
var folkertdev$elm_deque$BoundedDeque$pushFront = F2(
	function (elem, deque) {
		...
		if (!maxSize) {
			...
			var _n0 = folkertdev$elm_deque$BoundedDeque$reachedMaxSize(deque) ? folkertdev$elm_deque$BoundedDeque$popBack(deque).b : deque;
			var newDeque = _n0.a;
			var newMaxSize = _n0.b;
...
var author$project$Plane$Tail$push = F2(
	function (position, _n0) {
		var tail = _n0;
		return _Utils_update(
			tail,
...
var author$project$Plane$wrap = F3(
	function (width, height, _n0) {
		var aPlane = _n0;
		var location = aPlane.q;
		var y = A2(elm$core$Basics$modBy, height, location.a0);
		var x = A2(elm$core$Basics$modBy, width, location.a$);
...
var author$project$World$tick = function (_n0) {
	...
	var nextPlane = A3(
		...
		width,
		height,
		author$project$Plane$move(plane));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('plane', true),
							_Utils_Tuple2(
							author$project$Plane$Compass$toString(compass),
							true)
						])),
					A2(
					elm$html$Html$Attributes$style,
					'left',
					author$project$Rendering$Html$calculateSize(position.a$)),
					A2(
					elm$html$Html$Attributes$style,
					'bottom',
					author$project$Rendering$Html$calculateSize(position.a0))
				]),
			_List_Nil);
	});
...
var author$project$Rendering$Html$rewardsToHtml = function (parts) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('rewards')
			]),
		A2(elm$core$List$map, author$project$Rendering$Html$rewardToHtml, parts));
};
var author$project$Rendering$Html$tailPartToHtml = function (position) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Rendering$Html$tailToHtml = function (parts) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('tail')
			]),
...
var author$project$Rendering$Html$shapeToHtml = function (shape) {
	switch (shape.$) {
		case 0:
			var direction = shape.a;
			var location = shape.b;
			return A2(author$project$Rendering$Html$planeToHtml, direction, location);
		case 1:
			var parts = shape.a;
			return author$project$Rendering$Html$tailToHtml(parts);
		case 2:
			var width = shape.a;
			var height = shape.b;
			var score = shape.c;
...
var folkertdev$elm_deque$BoundedDeque$toList = function (_n0) {
	var deque = _n0.a;
	return folkertdev$elm_deque$Internal$toList(deque);
};
...
var author$project$Rendering$Tail = function (a) {
	return {$: 1, a: a};
};
var author$project$Rendering$followedBy = F2(
	function (last, first) {
		return _Utils_ap(first, last);
	});
var author$project$Rendering$rendition = function (shape) {
	return _List_fromArray(
		[shape]);
};
var author$project$Plane$render = function (_n0) {
	...
	var planeRendering = author$project$Rendering$rendition(
...
var author$project$World$render = F2(
	function (relativeScore, _n0) {
		...
		return A2(
			...
			A2(
				author$project$Rendering$followedBy,
				author$project$World$renderReward(aWorld._),
				author$project$Rendering$rendition(
					A3(author$project$Rendering$World, aWorld.ao, aWorld.ad, relativeScore))));
	});
...
var author$project$Wish$view = function (model) {
	...
	var relativeScore = A2(elm$core$Basics$min, 1.0, score / model.G);
...
var author$project$Wish$main = elm$browser$Browser$element(
	{bj: author$project$Wish$init, bD: author$project$Wish$subscriptions, bH: author$project$Wish$update, bJ: author$project$Wish$view});
															...
															return A2(
																...
																function (delta) {
																	return elm$json$Json$Decode$succeed(
																		{ab: delta, ad: height, G: maximumScore, H: message, aj: repeat, ao: width, a$: x, a0: y});
																},
																A2(elm$json$Json$Decode$field, 'delta', elm$json$Json$Decode$int));
														},
														A2(elm$json$Json$Decode$field, 'height', elm$json$Json$Decode$int));
												},
												A2(elm$json$Json$Decode$field, 'maximumScore', elm$json$Json$Decode$int));
										},
										A2(elm$json$Json$Decode$field, 'message', elm$json$Json$Decode$string));
								},
								A2(elm$json$Json$Decode$field, 'repeat', elm$json$Json$Decode$int));
						},
